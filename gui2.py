...
class WorkerThread(QThread):
    ...
    def __init__(self, audio_files, segment_duration, silence_thresh, output_format):
        super().__init__()
...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.output_format_combo.addItems(["mp3", "wav", "flac", "ogg", "m4a"])
    ...
    def start(self):
        ...
        self.worker_thread = WorkerThread(audio_files, segment_duration, silence_thresh, output_format)
